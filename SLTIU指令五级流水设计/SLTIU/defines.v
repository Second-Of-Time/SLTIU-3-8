...
`define EXE_RES_ARITHMETIC 3'b100       //算数逻辑
...
`define InstBus 31:0                //ROM的数据�?�线宽度
`define InstMemNum 32768            //ROM的实际大小为128KB(32*1024�?32�?(4字节)指令)
`define InstRealAddrBus 17          //ROM实际使用的地�?线宽�?
